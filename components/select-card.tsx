...
const SelectCard = ({ title, text, imageData, classNames }: SelectCardProps) => {
  return (
    <div className={cn("card relative min-h-[200px] md:max-w-[250px] max-w-[200px] w-full bg-cover bg-center overflow-hidden md:min-h-[300px] bg-gradient-to-t from-black via-black to-black/20 shadow-boxShadow shadow-lg rounded-2xl", classNames)}>
      <Image
        src={imageData.src}
        alt={imageData.alt}
        fill
